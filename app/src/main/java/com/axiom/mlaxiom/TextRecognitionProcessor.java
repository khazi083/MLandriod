...
import com.axiom.mlaxiom.common.CameraImageGraphic;
import com.axiom.mlaxiom.common.FrameMetadata;
...
public class TextRecognitionProcessor extends VisionProcessorBase<FirebaseVisionText> {
        ...
        for (int i = 0; i < blocks.size(); i++) {
            ...
            for (int j = 0; j < lines.size(); j++) {
                ...
                for (int k = 0; k < elements.size(); k++) {
                    ...
                    data.add(elements.get(k).getText());
                }
            }
        }
    ...
    public List<String> getReadBlocks(){
        return data;
    }
}
